...
const ImageList = [
  {
    ...
    description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit odio architecto ea aut amet nulla ipsum esse. Distinctio reiciendis ea, unde deserunt illo consequatur inventore quia amet eius, esse sint."
  },
  {
    id: 2,
    img: Image2,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="order-1 sm:-order-2">
                  <div data-aos="zoom-in" data-aos-once="true" className="relative z-10">
                    <img src={data.img} alt="slider images" className="w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-105 lg:scale-125 object-contain mx-auto" />
                  </div>
                </div>
              </div>
            </div>
